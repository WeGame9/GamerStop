...
import { FreeService } from 'src/app/free.service';
import { Top2021Service } from 'src/app/top2021.service';

@Component({
  selector: 'app-addhomepage',
  templateUrl: './addhomepage.component.html',
  styleUrls: ['./addhomepage.component.css']
})
